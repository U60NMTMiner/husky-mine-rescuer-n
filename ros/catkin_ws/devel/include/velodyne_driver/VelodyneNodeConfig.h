...
namespace velodyne_driver
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(VelodyneNodeConfig &config, const VelodyneNodeConfig &max, const VelodyneNodeConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const VelodyneNodeConfig &config1, const VelodyneNodeConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, VelodyneNodeConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const VelodyneNodeConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, VelodyneNodeConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const VelodyneNodeConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const VelodyneNodeConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, VelodyneNodeConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/nix/store/gimjz2k8rmpmmrbggh1s0880yarm5580-ros-env/lib/python3.10/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(VelodyneNodeConfig::AbstractParamDescriptionConstPtr(new VelodyneNodeConfig::ParamDescription<double>("time_offset", "double", 1, "A manually calibrated offset (in seconds) to add to the timestamp before publication of a message.", "", &VelodyneNodeConfig::time_offset)));
//#line 291 "/nix/store/gimjz2k8rmpmmrbggh1s0880yarm5580-ros-env/lib/python3.10/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(VelodyneNodeConfig::AbstractParamDescriptionConstPtr(new VelodyneNodeConfig::ParamDescription<double>("time_offset", "double", 1, "A manually calibrated offset (in seconds) to add to the timestamp before publication of a message.", "", &VelodyneNodeConfig::time_offset)));
//#line 291 "/nix/store/gimjz2k8rmpmmrbggh1s0880yarm5580-ros-env/lib/python3.10/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.enabled = 0;
//#line 291 "/nix/store/gimjz2k8rmpmmrbggh1s0880yarm5580-ros-env/lib/python3.10/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.enabled = 1;
...
//#line 291 "/nix/store/gimjz2k8rmpmmrbggh1s0880yarm5580-ros-env/lib/python3.10/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(VelodyneNodeConfig::AbstractParamDescriptionConstPtr(new VelodyneNodeConfig::ParamDescription<bool>("enabled", "bool", 2, "Switch to enable and disable lidar packet consumption", "", &VelodyneNodeConfig::enabled)));
//#line 291 "/nix/store/gimjz2k8rmpmmrbggh1s0880yarm5580-ros-env/lib/python3.10/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(VelodyneNodeConfig::AbstractParamDescriptionConstPtr(new VelodyneNodeConfig::ParamDescription<bool>("enabled", "bool", 2, "Switch to enable and disable lidar packet consumption", "", &VelodyneNodeConfig::enabled)));
